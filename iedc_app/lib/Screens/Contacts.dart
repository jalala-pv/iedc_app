                 ...
                 padding: const EdgeInsets.only(top: 20, left: 20),
                  child: Column(
                    children: [
                      ...
                      Text('\nFill up the form and our team will get back to you within 24 hours',style: TextStyle(color: Colors.white,fontSize: font*15),
                      
                      ),
                     contactListtile(icon: Icons.call, text: '+91 7306096088',),
                     contactListtile(icon: Icons.mail, text: 'iedcsscollege@gmail.com',),
                     contactListtile(icon: Icons.location_pin, text: ' Ssc @Areekode, Malappuram, kerala',),
